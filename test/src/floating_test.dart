...
void main() {
  ...
  test(
    'pipStatus returns PiPStatus.disabled if platform returned null',
    () async {
      tester.setMockMethodCallHandler(channel, (MethodCall methodCall) async {
        switch (methodCall.method) {
          case 'pipAvailable':
  ...
  test(
    'pipStatus returns PiPStatus.automatic if PiP is auto enabled',
    () async {
      tester.setMockMethodCallHandler(channel, (MethodCall methodCall) async {
        switch (methodCall.method) {
          case 'pipAvailable':
  ...
  test(
    'enablePip returns PiPStatus.unavailable if platform returned null',
    () async {
      tester.setMockMethodCallHandler(channel, (MethodCall methodCall) async {
        switch (methodCall.method) {
          case 'enablePip':
