...
void main() {
  testWidgets('Shows childWhenEnabled when status is enabled', (tester) async {
  ...
  testWidgets('Shows childWhenDisabled when status is disabled', (
    tester,
  ) async {
  ...
  testWidgets('Shows childWhenDisabled when status is unavailable', (
    tester,
  ) async {
